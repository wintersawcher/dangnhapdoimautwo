...
class MyNewfeed extends StatelessWidget {
  const MyNewfeed({Key? key}) : super(key: key);
...
class Choice {
  ...
  const Choice({required this.title, required this.date, required this.description, required this.imglink});
}
